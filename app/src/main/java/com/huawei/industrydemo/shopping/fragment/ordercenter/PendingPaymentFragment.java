...
public class PendingPaymentFragment extends Fragment implements OnOrderListRefresh {
    ...
    public PendingPaymentFragment(OrderCenterActivity activity, User user) {
        this.mUser = user;
    ...
    public void onDataRefresh() {
        ...
        if (null != mUser) {
            orderList = new OrderRepository().queryByUserAndStatus(mUser, Constants.NOT_PAID);
        }
    ...
    private void initView(View view) {
        RecyclerView recyclerOrderList = view.findViewById(R.id.pending_payment_list_order);

 ...
 * @see OrderCenterActivity
 * @since [Ecommerce-Demo 1.0.0.300]
 */
public class ExpressingFragment extends Fragment implements OnOrderListRefresh {

    private static final String TAG = ExpressingFragment.class.getSimpleName();
    ...
    public ExpressingFragment(OrderCenterActivity activity, User user) {
        this.mUser = user;
    ...
    public void onDataRefresh() {
        ...
        if (null != mUser) {
            orderList = new OrderRepository().queryByUserAndStatus(mUser, Constants.HAVE_PAID);
        }
